...
public class DataUtil {
    ...
    */
    public static List<Map<String, ?>> getLists() {
    ...
    */
    public static List<Map<String, ?>> getVideos() {
        List<Map<String, ?>> result = new ArrayList<>();
    ...
    */
    public static List<Map<String, ?>> getBoxArts() {
        List<Map<String, ?>> result = new ArrayList<>();
    ...
    */
    public static List<Map<String, ?>> getBookmarkList() {
        List<Map<String, ?>> result = new ArrayList<>();
